...
function scene:create( event )
	...
	head = display.newText("     Surveillance Devices Act 2007 (NT)", display.contentCenterX*0.90,display.contentCenterY*0.10,"Arial",20)
	head:setFillColor(1,0,0)
	sceneGroup:insert(head)
	-- Path for the file to read
 
	local path = system.pathForFile( "file6.txt", system.ResourceDirectory )
