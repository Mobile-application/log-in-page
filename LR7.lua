...
function scene:create( event )
	...
	head = display.newText("     Invasion of Privacy Act 1971 (Qld)", display.contentCenterX*0.90,display.contentCenterY*0.10,"Arial",20)
	head:setFillColor(1,0,0)
	sceneGroup:insert(head)
	-- Path for the file to read
 
	local path = system.pathForFile( "file7.txt", system.ResourceDirectory )
