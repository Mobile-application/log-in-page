...
function scene:create( event )
	...
	head = display.newText("      Surveillance Devices Act 2007 (NSW)", display.contentCenterX*0.90,display.contentCenterY*0.10,"Arial",18)
	head:setFillColor(1,0,0)
	sceneGroup:insert(head)
	-- Path for the file to read
 
	local path = system.pathForFile( "file5.txt", system.ResourceDirectory )
