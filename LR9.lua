...
function scene:create( event )
	...
	head = display.newText("      Surveillance Devices Act 1991 (Tas)", display.contentCenterX*0.90,display.contentCenterY*0.10,"Arial",19)
	head:setFillColor(1,0,0)
	sceneGroup:insert(head)
	-- Path for the file to read
 
	local path = system.pathForFile( "file9.txt", system.ResourceDirectory )
