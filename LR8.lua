...
function scene:create( event )
	...
	head = display.newText("      Listening and Surveillance Devices Act 1972 (SA)", display.contentCenterX*0.90,display.contentCenterY*0.10,"Arial",14)
	head:setFillColor(1,0,0)
	sceneGroup:insert(head)
	-- Path for the file to read
 
	local path = system.pathForFile( "file8.txt", system.ResourceDirectory )
